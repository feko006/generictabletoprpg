...
import com.feko.generictabletoprpg.additional_bonus_hint
...
import com.feko.generictabletoprpg.initiative_additional_bonus
import com.feko.generictabletoprpg.level
import com.feko.generictabletoprpg.name
import com.feko.generictabletoprpg.passive_skills
import com.feko.generictabletoprpg.proficiency
import com.feko.generictabletoprpg.proficiency_bonus
import com.feko.generictabletoprpg.saving_throw_additional_bonus
import com.feko.generictabletoprpg.saving_throw_proficiency
import com.feko.generictabletoprpg.saving_throws
import com.feko.generictabletoprpg.score
...
import com.feko.generictabletoprpg.skill_additional_bonus
import com.feko.generictabletoprpg.skill_bonuses
import com.feko.generictabletoprpg.spell_attack_additional_bonus
    ...
    AlertDialogBase(
        ...
        BoxWithScrollIndicator(
            ...
            Column(Modifier.verticalScroll(scrollState)) {
                ...
                HeaderWithDividers(stringResource(Res.string.saving_throws))
                ...
                HeaderWithDividers(stringResource(Res.string.skill_bonuses))
...
private fun EditDialog(
    ...
    AlertDialogBase(
        ...
        DialogInputField(
            ...
            "${stringResource(Res.string.name)} ($defaultName)",
            onValueChange = {
...
fun StatsEditDialog(
    ...
    AlertDialogBase(
        ...
        BoxWithScrollIndicator(
            ...
            Column(Modifier.verticalScroll(scrollState)) {
                Text(
                    stringResource(Res.string.additional_bonus_hint),
                    Modifier
                        .fillMaxWidth()
                ...
                DialogInputField(
                    ...
                    label = "${stringResource(Res.string.name)} ($defaultName)",
                    onValueChange = { onValueUpdate(editedStats.copy(name = it)) }
                )
                NumberDialogInputField(
                    value = statsContainer.proficiencyBonus,
                    label = stringResource(Res.string.proficiency_bonus),
                    convertInputValue = IInputFieldValueConverter.IntInputFieldValueConverter,
                    onValueChange = {
                        onValueUpdate(
                ...
                NumberDialogInputField(
                    ...
                    label = stringResource(Res.string.initiative_additional_bonus),
                    convertInputValue = IInputFieldValueConverter.IntInputFieldValueConverter,
                    onValueChange = {
                        onValueUpdate(
                            editedStats.copy(
                ...
                NumberDialogInputField(
                    ...
                    label = stringResource(Res.string.spell_save_dc_additional_bonus),
                    convertInputValue = IInputFieldValueConverter.IntInputFieldValueConverter,
                    onValueChange = {
                        onValueUpdate(
                            editedStats.copy(
                ...
                NumberDialogInputField(
                    ...
                    label = stringResource(Res.string.spell_attack_additional_bonus),
                    convertInputValue = IInputFieldValueConverter.IntInputFieldValueConverter,
                    onValueChange = {
                        onValueUpdate(
                            editedStats.copy(
...
private fun StatsStatEntry(
    ...
    key("editStatEntry-$statIndex") {
        ...
        NumberDialogInputField(
            ...
            label = "${stringResource(Res.string.score)}$bonusText",
            convertInputValue = IInputFieldValueConverter.IntInputFieldValueConverter,
            onValueChange = {
        ...
        NumberDialogInputField(
            ...
            label = stringResource(Res.string.saving_throw_additional_bonus),
            convertInputValue = IInputFieldValueConverter.IntInputFieldValueConverter,
            onValueChange = {
                val newStatEntry =
    ...
    Column(
        ...
        key("editStatEntry-$statIndex-$skillIndex") {
            ...
            NumberDialogInputField(
                ...
                label = stringResource(Res.string.skill_additional_bonus),
                convertInputValue = IInputFieldValueConverter.IntInputFieldValueConverter,
                onValueChange = { bonus ->
                    val newStatEntry =
